...
///
/// This function will start the specified number of connections and a progress tracker.
///
/// It will wait for the provided shutdown future to resolve, then signal all tasks to shutdown.
