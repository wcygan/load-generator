...
/// Creates a future that will be used to signal shutdown.
///
/// If a time is provided, the future will resolve after that time.
/// Otherwise, it will resolve when the user presses Ctrl+C.
